...
let btn_scroll_top = document.getElementById("btn-scroll-top");
...
window.onscroll = () => {
	if(window.scrollY < 300){
		btn_scroll_top.classList.remove("btn_scroll_top_on")
	}else{
		btn_scroll_top.classList.add("btn_scroll_top_on")
	}
};